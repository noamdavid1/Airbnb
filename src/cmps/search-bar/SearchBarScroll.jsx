export function SearchBarScroll({ onExpandSearch }) {
    ...
    return (
        <section className="search-bar">
            <div className="search-bar-text" onClick={() => onExpandSearch('where')}>Anywhere</div>
            <div className="search-bar-text" onClick={() => onExpandSearch('check-in')}>Any week</div>
            <div className="search-bar-text" onClick={() => onExpandSearch('who')}>Add guests</div>
